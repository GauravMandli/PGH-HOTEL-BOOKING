...
if(isset($_POST['submit']))
{
  ...
  $q="insert into rooms (hotelId,roomNo,roomType,roomImage,roomRent,details)values('$hotelId','$roomNo','$roomType','$roomImage','$roomRent','$detail')";
  mysqli_query($con,$q);
  //print $q;
}
?>
...
<section class="w3l-breadcrumb">
    <div class="breadcrum-bg py-sm-5 py-4">
        <div class="container py-lg-3">
            <h2>ROOM</h2>
            <p><a href="admin-home.php">Home</a> &nbsp; / &nbsp; Add Room</p>
    ...
    <div class="contacts-9 py-lg-5 py-sm-4">
        <div class="container">
            <div class="d-grid contact-view">
                <div class="">
                    <h3 class="title-big">ADD ROOM</h3>
                     <p>
                ...
                <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <div class="twice">
                            <input type="text" class="form-control" name="roomRent" id="w3lSubject"
                                placeholder="Rent (RS)" required="">
                        </div>
                    
                        <div class="twice">
                            <textarea class="form-control" name="details" id="w3lSubject"
                                placeholder="Details" required=""></textarea>
                        </div>
                        
                        <button type="submit" name="submit" class="btn btn-contact">ADD ROOM</button>
                    </form>
