...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 28, 2024 at 05:52 AM
...
CREATE TABLE IF NOT EXISTS `galleries` (
  `gallId` int(5) NOT NULL AUTO_INCREMENT,
  `hotelId` int(5) NOT NULL,
...
(10, 1, '2024-10-09', 'good', 6),
(9, 1, '2024-10-09', 'good', 6),
(8, 1, '2024-10-09', 'good', 6),
(7, 1, '2024-10-09', 'good', 6);
